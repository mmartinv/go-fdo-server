...
func TestContentNegotiationMiddleware(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			type handlerFunc = func(context.Context, http.ResponseWriter, *http.Request, any) (any, error)
			mw := ContentNegotiationMiddleware[handlerFunc](availableTypes, "application/json")
