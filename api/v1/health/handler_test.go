...
// TestHealthError_Message verifies error response uses components.InternalServerErrorJSONResponse
func TestHealthError_Message(t *testing.T) {
	...
	var _ components.InternalServerErrorJSONResponse = resp500.InternalServerErrorJSONResponse
