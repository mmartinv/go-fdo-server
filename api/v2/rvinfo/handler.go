...
func (s *Server) GetRendezvousInfo(
	ctx context.Context,
	request GetRendezvousInfoRequestObject,
) (GetRendezvousInfoResponseObject, error) {
...
func (s *Server) UpdateRendezvousInfo(
	ctx context.Context,
	request UpdateRendezvousInfoRequestObject,
) (UpdateRendezvousInfoResponseObject, error) {
	...
	if err != nil {
		...
		return UpdateRendezvousInfo400JSONResponse{
			components.BadRequestJSONResponse{Message: "invalid rendezvous info"},
		}, nil
	}
	...
	if err != nil {
		...
		return UpdateRendezvousInfo500JSONResponse{
			components.InternalServerErrorJSONResponse{Message: "failed to read back saved rendezvous info"},
		}, nil
	}
	...
	if err != nil {
		...
		return UpdateRendezvousInfo500JSONResponse{
			components.InternalServerErrorJSONResponse{Message: "failed to format saved rendezvous info"},
		}, nil
	}
...
func (s *Server) DeleteRendezvousInfo(
	ctx context.Context,
	request DeleteRendezvousInfoRequestObject,
) (DeleteRendezvousInfoResponseObject, error) {
